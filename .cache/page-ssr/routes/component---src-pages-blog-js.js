...
function BlogPage() {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "My cool posts will go in here"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("ul", null, data.allFile.nodes.map(node => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", {
    key: node.name
  }, node.name))));
}
...
"use strict";
module.exports = JSON.parse('{"data":{"allFile":{"nodes":[{"name":"another-post"},{"name":"my-first-post"},{"name":"yet-another-post"}]}}}');
